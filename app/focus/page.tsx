      ...
      <header className="h-14 sm:h-16 border-b border-border bg-surface-elevated/80 backdrop-blur-sm sticky top-0 z-20">
        <div className="h-full mx-auto px-3 sm:px-6 lg:px-8 flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-sm sm:text-lg font-bold text-on-surface truncate">Focus Timer</h1>
            <p className="text-on-surface-secondary text-xs hidden lg:block">Stay present. Work deeply.</p>
          </div>
          <UserMenu email={user.email} username={profile?.username} />
        </div>
      </header>

      {/* Content - Less padding on mobile for timer-focused experience */}
      <div className="mx-auto px-3 py-4 sm:px-6 sm:py-8 lg:px-8 lg:py-12 max-w-[1400px]">
        <FocusPageClient
